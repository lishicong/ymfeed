...
public class HomeController {
	...
	public String getWelcome(HttpServletRequest request, Model model) {

		String param = request.getParameter("param");
		System.out.println("param1:" + param);

		List<Info> info = this.uinfoService.getInfo();
	...
	public @ResponseBody List<Info> getFeedList(@RequestParam("param") String param) {
		System.out.println("param2:" + param);
		List<Info> info = this.uinfoService.getInfo();

		info.addAll(getExample());

		return info;
	}

	private List<Info> getExample() {
